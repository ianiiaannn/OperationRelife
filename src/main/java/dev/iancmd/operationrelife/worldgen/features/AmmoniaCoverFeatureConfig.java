...
public record AmmoniaCoverFeatureConfig(BlockStateProvider cover, IntProvider branchLength, IntProvider projection,
  ...
  public static final Codec<AmmoniaCoverFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(BlockStateProvider.CODEC.fieldOf("cover").forGetter(AmmoniaCoverFeatureConfig::cover),
