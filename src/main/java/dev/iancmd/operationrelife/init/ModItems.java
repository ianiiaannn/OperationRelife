...
public class ModItems {
  ...
  public static class ItemRegistry {
    ...
    public static final RegistryObject<Item> UPPER_SURFACE_ICE = ItemRegistry.REGISTER.register("upper_surface_ice", () -> new BlockItem(ModBlocks.BlockRegistry.UPPER_SURFACE_ICE.get(), new Item.Properties().rarity(Rarity.COMMON)));
  }
}
